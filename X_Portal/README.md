...
**项目说明** 
- X_Portal 是一个轻量级的Java快速开发平台，基于各大开源项目组合而来，用于快速构建中小型API、RESTful API项目，该项目已经有过多个真实项目的实践，稳定、简单、快速，使我们摆脱那些重复劳动。

- 专为X_Portal 量身定制《接口》代码生成工具https://github.com/yzcheng90/X_Portal-inteface-generatorper

- 专为X_Portal 量身定制《后台管理》代码生成工具https://github.com/yzcheng90/X_Portal-generator

- 专为X_Portal 量身定制《安卓快速开发框架》https://github.com/yzcheng90/x-android
...
![image](https://github.com/yzcheng90/X_Portal/blob/master/pic/AppBaseResult_img.png)
<br>
<h3>统一接口请求和返回工具类 <a href="https://github.com/yzcheng90/X_Portal/blob/master/src/main/java/com/suke/czx/common/utils/AppBaseResult.java">AppBaseResult.java</a></h3>
<br>
<h3>数据返回加解密工具类 <a href="https://github.com/yzcheng90/X_Portal/blob/master/src/main/java/com/suke/czx/common/utils/CDESCrypt.java">CDESCrypt.java</a></h3>
...
![image](https://github.com/yzcheng90/X_Portal/blob/master/pic/20180108172123_1.png)
![image](https://github.com/yzcheng90/X_Portal/blob/master/pic/20180108172123_2.png)
![image](https://github.com/yzcheng90/X_Portal/blob/master/pic/20180108172123_3.png)

 **本地部署**
- 下载源码
- 创建数据库X_Portal，数据库编码为UTF-8
- 执行doc/db.sql文件，初始化数据
- 修改application-dev.yml，更新MySQL账号和密码
- Eclipse、IDEA运行Application.java，则可启动项目
- 项目访问路径：http://localhost:8080/X_Portal
- 账号密码：admin/admin
- Swagger路径：http://localhost:8080/X_Portal/swagger/index.html
- 交流QQ群：17470566
- 本人QQ：913624256
- 如果喜欢，记得star fork 谢谢您的关注 X_Portal会持续维护
