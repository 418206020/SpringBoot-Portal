...
public class LoginController {
    ...
    @PostMapping("user")
    public ReturnAppInfo<UserLoginRep> loginMap(@RequestBody BodyInfo bodyInfo, @RequestHeader HttpHeaders headers) throws Exception {
...
//        return ReturnAppInfo.success().setEncryptData(userLoginRep);//
    }
